...
package body aBLAS_Test_Suite is
   ...
   package Float_Real_Level2 is new aBLAS_Test_Suite.Real_Level2(Float_BLAS,
                                                                 "Float");
   ...
   package Long_Float_Real_Level2 is new aBLAS_Test_Suite.Real_Level2(Long_Float_BLAS,
                                                                      "Long_Float");
