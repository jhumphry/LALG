...
pragma Elaborate_All(aBLAS, aBLAS.Real_BLAS);

with aBLAS_Real_Level1;
with aBLAS_Real_Level2;
with aBLAS_Real_Level3;
...
package body aBLAS_Test_Suite is
   ...
   package Float_Real_Level1 is new aBLAS_Real_Level1(Float_BLAS_Base,
                                                      Float_BLAS,
                                                      "Float");
   Test_Float_Real_Level1 : aliased Float_Real_Level1.Level1_Test;

   package Float_Real_Level2 is new aBLAS_Real_Level2(Float_BLAS_Base,
                                                                 Float_BLAS,
                                                                 "Float");
   Test_Float_Real_Level2 : aliased Float_Real_Level2.Level2_Test;

   package Float_Real_Level3 is new aBLAS_Real_Level3(Float_BLAS_Base,
                                                                 Float_BLAS,
                                                                 "Float");
   ...
   package Long_Float_Real_Level1 is new aBLAS_Real_Level1(Long_Float_BLAS_Base,
                                                                      Long_Float_BLAS,
                                                                      "Long_Float");
   Test_Long_Float_Real_Level1 : aliased Long_Float_Real_Level1.Level1_Test;

   package Long_Float_Real_Level2 is new aBLAS_Real_Level2(Long_Float_BLAS_Base,
                                                                      Long_Float_BLAS,
                                                                      "Long_Float");
   Test_Long_Float_Real_Level2 : aliased Long_Float_Real_Level2.Level2_Test;

   package Long_Float_Real_Level3 is new aBLAS_Real_Level3(Long_Float_BLAS_Base,
                                                                      Long_Float_BLAS,
                                                                      "Long_Float");
